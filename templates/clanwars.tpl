    ...
    <table class="table">
        ...
        {foreach from=$objects item=cw}
            ...
            <tr>
                ...
                <td>{if $cw->status == "1"}<span class="cw-won"">Gewonnen</span>{elseif $cw->status == "x"}<span class="cw-draw">Unentschieden</span>{else}<span class="cw-loss">Verloren</span>{/if}</td>
                <td>{@$cw->time|time}</td>
